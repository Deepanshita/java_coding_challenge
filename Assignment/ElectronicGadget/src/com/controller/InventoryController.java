	...
	public static void main(String[] args) {
		...
		InventoryService is=new InventoryService();
			while(true) {
				...
				System.out.println("Press 2. Remove from Inventory");
				System.out.println("Press 3. List Low Stock Products");
				System.out.println("Press 4. List Out of Stock Products");
				System.out.println("Press 5. is product Available");
				...
				case 2:
					 try {
				            System.out.println("Enter Inventory ID to Remove Quantity:");
				            int inventoryID = sc.nextInt();
				            System.out.println("Enter Quantity to Remove:");
				            int quantityToRemove = sc.nextInt();
				            sc.nextLine(); 

				            is.removeFromInventory(inventoryID, quantityToRemove);
				            System.out.println("Quantity removed from inventory successfully.");
				        } catch (Exception e) {
				            System.out.println("Error removing quantity from inventory: " + e.getMessage());
				        }
					    break;
